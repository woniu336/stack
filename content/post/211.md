...
```bash
rclone sync D:\blog Tencent-cos:woniu336-1253486782\blog -u -v -P --transfers=20 --ignore-errors --buffer-size=128M --check-first --checkers=10 --drive-acknowledge-abuse --include "/{.obsidian,.shell}/**"
```

...
var ClockView = class extends import_obsidian.ItemView {
  ...
  sortTimeZones() {
    ...
    let sortedTimeZones = this.plugin.settings.timeZonePairs.slice().sort((a, b) => {
...
var ClockSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    const weekStartSetting = new import_obsidian.Setting(containerEl).setName("Week Starts On").setDesc(
      ...
      dropdown.addOptions({ sunday: "Sunday", monday: "Monday" }).setValue(this.plugin.settings.weekStart).onChange(async (value) => {
    ...
    const showTimezonesSetting = new import_obsidian.Setting(containerEl).setName("Show timezones").setDesc("Enable to show the timezones.").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showTimeZone).onChange(async (value) => {
        ...
        timezonePairsSetting.settingEl.style.display = value ? "" : "none";
        reverseTimezoneOrderSetting.settingEl.style.display = value ? "" : "none";
      });
    });
    showTimezonesSetting.settingEl.classList.add("show-timezones-settings");
    const reverseTimezoneOrderSetting = new import_obsidian.Setting(containerEl).setName("Reverse Timezone Order").setDesc("Reverse the order of displayed timezones.").addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.reverseTimezoneOrder).onChange(async (value) => {
    ...
    reverseTimezoneOrderSetting.settingEl.style.display = this.plugin.settings.showTimeZone ? "" : "none";
